...
var CONFIG = {
   ...
   tileSize: 150,
   tileMargin: 6,
   serverUrl: 'https://automation-app.prettybaked.com',
   wsUrl: 'wss://automation-app.prettybaked.com/api/websocket',
   ...
   onReady: function () {
      CONFIG.googleApiToken = (this.states['sensor.google_api_token'] || {}).state;
      CONFIG.mapboxToekn = (this.states['sensor.mapbox_api_key'] || {}).state;
   },
